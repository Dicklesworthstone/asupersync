...
//!
//! Usage:
//!   cargo run --bin h2_connect_method_conformance
//!   cargo run --bin h2_connect_method_conformance -- --format json
//!   cargo run --bin h2_connect_method_conformance -- --output report.md
