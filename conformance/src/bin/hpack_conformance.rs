...
fn generate_summary_output(report: &asupersync_conformance::HpackComplianceReport) -> String {
...
fn print_test_summary(report: &asupersync_conformance::HpackComplianceReport) {
