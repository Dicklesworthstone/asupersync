...
pub use doctor::{
    ...
    operator_model_contract, parse_git_short_status, parse_remediation_recipe,
    remediation_recipe_bundle, remediation_recipe_contract, remediation_recipe_fixtures,
    run_agent_swarm_status_smoke, run_core_diagnostics_report_smoke, run_remediation_recipe_smoke,
...
pub mod prelude {
    ...
    pub use super::doctor::{
        ...
        emit_lock_contention_structured_events, emit_structured_log_event,
        ...
        simulate_screen_exchange, structured_logging_contract,
        validate_agent_swarm_status_contract, validate_core_diagnostics_report,
