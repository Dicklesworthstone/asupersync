...
mod tests {
    ...
    fn cache_to_seeding_workflow_integration() {
        ...
        seeding_service
            .authorize_manifest(&manifest_key.manifest_hash, vec!["test-scope".to_string()]);
        ...
        let seeding_result = seeding_service
            .start_seeding_session(&seeding_request)
    ...
    fn seeding_authorization_and_security_validation() {
        ...
        seeding_service
            .authorize_manifest("authorized_manifest", vec!["allowed-scope".to_string()]);
