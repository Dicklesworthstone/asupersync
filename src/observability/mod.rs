...
pub use diagnostics::{
    ...
    RegionOpenExplanation, StalledRaceDrain, TAIL_LATENCY_BUDGET_CERTIFICATE_SCHEMA_VERSION,
...
#[cfg(all(feature = "metrics", not(target_arch = "wasm32")))]
pub use otel::{
    OTLP_HTTP_MAX_RESPONSE_BYTES, OWNED_OTLP_DEFAULT_LOG_RECORDS_PER_REQUEST,
    OWNED_OTLP_DEFAULT_METRICS_PER_REQUEST, OWNED_OTLP_DEFAULT_REQUEST_BYTES,
    OWNED_OTLP_DEFAULT_SPANS_PER_REQUEST, OWNED_OTLP_LOGS_VERSION, OWNED_OTLP_MAX_ATTRIBUTE_BYTES,
    ...
    OWNED_OTLP_MAX_LINKS_PER_SPAN, OWNED_OTLP_MAX_LOG_BODY_DEPTH, OWNED_OTLP_MAX_LOG_BODY_ITEMS,
    ...
    OtlpHttpExporter, OtlpHttpResponse, OtlpLogBody, OtlpLogKeyValueInput, OtlpLogRecordInput,
    OtlpTlsPolicy, OtlpTraceEventInput, OtlpTraceLinkInput, OtlpTraceSpanInput, OtlpTraceStatus,
