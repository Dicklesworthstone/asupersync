...
pub use swarm_replay::{
    ...
    SwarmDiskPressureLevel, SwarmDiskPressureTransition, SwarmFailureBundle,
    SwarmFailureInvariantClass, SwarmFailureMinimizerInput, SwarmFailureMinimizerReport,
    SwarmFailureMinimizerStopReason, SwarmFailureMinimizerVerdict, SwarmFailureReductionStep,
    ...
    build_swarm_operator_cockpit_report, minimize_swarm_failure, plan_swarm_admission_wave,
    plan_swarm_proof_lane, render_swarm_contention_heatmap_text,
