...
export const browser_operator_snapshot: (a: number) => void;
...
export const __wasm_bindgen_func_elem_383: (a: number, b: number, c: number) => void;
export const __wasm_bindgen_func_elem_383_3: (a: number, b: number, c: number) => void;
