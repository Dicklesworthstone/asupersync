...
const BASELINE_CURRENT_REVISION: &str = "4376cddb3ec421767029bff87ed1ef747e693ce5";
...
const LIVE_BASELINE_SHA256: &str =
    "09404498819adb29849d4d6c955e7aaac876b6fb40a1e8144606bdb090502c40";
...
const CLAIMS_PROJECTION_SHA256: &str =
    "e876bd3636e8f3b933346b16d1832a96290e1676b911c55d6bcee327aa61394d";
...
fn validate_post_capture_provenance_refresh(corpus: &Value) -> Result<(), String> {
    ...
    let expected_revisions: BTreeSet<String> = [
        ...
        "612a82a546634ba1de2d06fe6e429bf85516a475",
