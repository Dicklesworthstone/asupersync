...
// Public framing tests run without building the monolithic library test executable.
mod binary_framing {
    use asupersync::bytes::BytesMut;
    use asupersync::codec::{Decoder, Encoder, FramedRead};
    ...
    use asupersync::net::atp::protocol::transcript::TranscriptHasher;
    ...
    #[test]
    fn oversized_frame_refusal_preserves_input_and_accepts_a_valid_successor() {
        let mut frame =
