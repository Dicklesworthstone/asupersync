...
fn required_runtime_roundtrips_are_cataloged() -> TestResult {
    ...
    for required in [
        ...
        "roundtrip.browser_core.handle_ref_json",
        "roundtrip.browser_core.operator_snapshot_json",
        "roundtrip.distributed.region_snapshot_binary",
        "roundtrip.distributed.replay_trace_binary",
        "roundtrip.trace.event_json",
        "roundtrip.trace.replay_event_msgpack",
        "roundtrip.lab.dual_run_replay_policy_json",
        "roundtrip.crashpack.evidence_ledger_json",
        "roundtrip.franken_kernel.trace_id_serde_json",
        "roundtrip.franken_decision.loss_matrix_json",
        "roundtrip.franken_evidence.ledger_json",
        "roundtrip.codec.grpc_message_frame",
        "roundtrip.grpc.prost_cross_implementation",
        "roundtrip.grpc.streaming_order",
