...
const ARTIFACT_SHA256: &str = "cec72082ef043153c1a41b46fa497ba100d6da2ce860760d1f0c0ed5f8ac49bd";
const DOC_SHA256: &str = "e058edeb0debbf9463850c1a9efbc107f88e7f0406f1d96e731b0fd608ee8cc0";
...
const VF5_DOWNSTREAM: &str = "asupersync-validation-frontier-v2-b5cjsv.5";
const DOC_BEGIN: &str = "<!-- BEGIN KAFKA K0.5 BASELINE DISPOSITION -->";
const DOC_END: &str = "<!-- END KAFKA K0.5 BASELINE DISPOSITION -->";

const IMPORTED_SOURCE_PIN_COUNT: usize = 267;
const UNIQUE_SOURCE_PATH_COUNT: usize = 248;
const SOURCE_PATH_OVERLAP_GROUP_COUNT: usize = 15;
const ALL_DEFINITION_AND_REFERENCE_COUNT: usize = 1_047;
const PRIMARY_STABLE_ID_COUNT: usize = 912;
const CORE_DEFINITION_ID_COUNT: usize = 901;
const CONTRADICTION_INPUT_ID_COUNT: usize = 11;
const AUTHORITY_REFERENCE_COUNT: usize = 135;
const PUBLIC_SYMBOL_JOIN_COUNT: usize = 33;
const SEMANTIC_JOIN_COUNT: usize = 102;
...
const LEXICAL_COLLISION_SITE_COUNT: usize = 249;
...
const REDUCED_UNKNOWN_SELECTOR_COUNT: usize = 130;
...
const LEXICAL_COLLISION_SHA256: &str =
    "ac5adcbcd832c0dd65b486a7aadf1103bb3d642bb57a006b0d3d8f3fd9a6a555";
...
const SOURCE_PIN_FULL_ROW_SHA256: &str =
    "e1bc2bd62823f8c5c8bb5593d4acb75c1f88a140efb85a80f638cfa955549efa";
...
const SOURCE_PIN_OVERLAP_SHA256: &str =
    "ccd6f96f55bc053948b8a675814a17408548f36d81af37fac89dceaf87d35a19";
...
const CLAIMS_FULL_ROW_SHA256: &str =
    "a4dc21b49e344bd9c8ba43adabd2c2551b33f7e029494347e1c8f30059ef2f50";
...
const LEXICAL_SITE_ID_SHA256: &str =
    "408cc618c56e83440ad07efe3750dc2c3a021ffbb6c4b32b5bd07e4759623e1f";
...
const CHILD_FILE_PINS: &[ChildFilePin] = &[
    ChildFilePin {
        ...
        sha256: "b90709fc2453f1aee9c281a52e8189e306cd2702e50c22c6c318855bcc1d5bac",
        byte_count: 47_361,
        record_count: 1_087,
    },
    ChildFilePin {
        ...
        sha256: "ce886a8581eb735b30f38b59d4707ab3739aac9d9774c19bdc0416b710bc69fc",
        byte_count: 11_083,
        record_count: 221,
    },
    ChildFilePin {
        ...
        sha256: "1b9e744169d9d7bddcf49c8378a3578a166655d4d54aaada4a635a8fa1b3230d",
        byte_count: 29_435,
        record_count: 867,
    },
    ChildFilePin {
        ...
        sha256: "a5045d8d466677ac052e3faa8279eb6e990b7e9b89f18e164da2de0b3a4bf780",
        byte_count: 244_004,
        record_count: 2_687,
    },
    ChildFilePin {
        ...
        sha256: "614de775f7b4a6c9c81f9cfc7b916fd5e7fdc9dc52985e608029fdc049791553",
        byte_count: 34_580,
        record_count: 580,
    },
    ChildFilePin {
        ...
        sha256: "724831535bc3f1e3f138607cd472e493791e34197ee4756042096e5cbe631104",
        byte_count: 72_831,
        record_count: 1_777,
    },
    ChildFilePin {
        ...
        sha256: "14dc8c84ffd985f8a8291ff3b99da8e7e542f3adf7974d04bf109205d08c5240",
        byte_count: 1_295_370,
        record_count: 19_932,
    },
    ChildFilePin {
        packet_id: "K0.3",
        ...
        sha256: "93311de5cdb5d5cff036e0d65eea4ad27d8ca38338eb253397c25700f3314f62",
        byte_count: 42_914,
        record_count: 641,
    },
    ChildFilePin {
        ...
        sha256: "c557cf3d8e25ed01f8d82c57fd169eb847840c934926f92fad1dd597380ccc5e",
        byte_count: 219_718,
        record_count: 5_452,
    },
    ChildFilePin {
        ...
        sha256: "08ed98695621a137e5268828193f454ec53016aa2076448fdc4c30c1898da0bd",
        byte_count: 122_592,
        record_count: 2_214,
    },
    ChildFilePin {
        ...
        sha256: "23b278530c81ef134c9a15c7e71ce3d1a8900f3abaaff2287daaa7138fab9196",
        byte_count: 26_498,
        record_count: 364,
    },
    ChildFilePin {
        ...
        sha256: "2ff32ea546079ddd819aa3e2a1063d846ee0012d2055840dffd64405bf52dd74",
        byte_count: 133_727,
        record_count: 3_567,
    },
];
...
fn validate_packet_identity_and_policy(packet: &Value) -> Result<(), String> {
    ...
    let review = packet
        ...
        .ok_or_else(|| "aggregate lacks current source review".to_owned())?;
    require_exact_keys(
        review,
        &[
            "reviewed_date_utc",
    ...
    if text(review, "reviewed_date_utc") != "2026-09-09"
        ...
        || text(review, "scope") != "CURRENT_SOURCE_STATIC_AGGREGATION_ONLY"
        || !bool_field(review, "historical_receipts_preserved")
        || unsigned(review, "new_execution_receipts") != 0
        || array(review, "reviewed_changes").len() != 5
        || !text(review, "interpretation").contains("remain unchanged")
    {
        return Err("current aggregation must preserve historical evidence boundaries".to_owned());
    }
...
fn validate_aggregate_coverage_sets(packet: &Value) -> Result<(), String> {
    ...
    if unsigned(source, "row_count") != IMPORTED_SOURCE_PIN_COUNT as u64
        || source.get("stage_counts")
            != Some(&serde_json::json!({"K0.1":14,"K0.2":8,"K0.3":225,"K0.4":20}))
    ...
    require_equal(
        ...
        serde_json::json!({
            "stage_counts": {"K0.1":100,"K0.2":152,"K0.3":469,"K0.4":191},
...
fn validate_aggregate_unknown_disposition(
    ...
    require_equal(
        ...
        serde_json::json!([
            ...
            },
            {
                ...
                "id_set_sha256":"a2250ed7e57cd991d1b50f327af483d3b9f91de11cdd5fd05bcb521ac7e0c1f4",
                "owner_field":"owner_bead",
                "required_owner":K14_REFRESH,
                "blocking":true
            },
            ...
            },
            {
                ...
                "id_set_sha256":"7832fa790e0e79ec6a0b404f6f28b480b869edf4d0543bc23e05dbd0c229c4d1",
    ...
    let route_owners = collect_route_edges(children)?
        ...
        .collect::<BTreeSet<_>>();
    let terminal_gates = expected_set(&[
        K12_TERMINAL,
        K13_TERMINAL,
        K14_REFRESH,
        K15_CUTOVER,
...
fn validate_disposition_gates_and_receipt(packet: &Value) -> Result<(), String> {
    ...
    require_equal(
        ...
        serde_json::json!([
            ...
            {"gate_id":"VF5","bead_id":VF5_DOWNSTREAM,"scope":"external downstream-consumer proof ownership only; not Kafka runtime evidence","state":"CLOSED_OWNER_ONLY_DOES_NOT_RESOLVE_KAFKA_UNKNOWN"}
        ]),
...
fn validate_docs(doc: &str) -> Result<(), String> {
    ...
    for required in [
        ...
        "The primary stable-ID receipt contains 912 unique IDs",
        "901 are core",
        "11 are K0.4 contradiction",
        "Source-pin canonical JSON | 267",
        "Unique source-pin paths | 248",
...
fn kafka_k0_baseline_disposition_is_exact_and_fail_closed() {
    ...
    assert_packet_mutation_rejected(&packet, &children, &tracker, doc, |mutated| {
        mutated["current_source_review"]["new_execution_receipts"] = Value::from(1);
    });
    assert_packet_mutation_rejected(&packet, &children, &tracker, doc, |mutated| {
