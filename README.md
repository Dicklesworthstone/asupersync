...
| [`docs/quic_atp_threat_model.md`](./docs/quic_atp_threat_model.md) | **ATP-over-QUIC Threat Model**: X.509, symbol-auth, replay, amplification, downgrade, and no-claim boundaries for untrusted peers |
