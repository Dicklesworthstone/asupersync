...
COMMAND="rch exec -- env ASUPERSYNC_GOVERNOR_STATE_SNAPSHOT_CONTRACT_PATH=${ARTIFACT} ASUPERSYNC_GOVERNOR_STATE_SNAPSHOT_SCENARIO=${SCENARIO} ASUPERSYNC_GOVERNOR_STATE_SNAPSHOT_REPORT_PATH=${SCENARIO_REPORT_PATH} cargo test -p asupersync --lib governor_state_snapshot_smoke_contract_emits_report --features test-internals -- --nocapture"
