...
The follow-ups at `f9328e57b` and `e3188231e` only clarify `builder.rs`
documentation for current-thread nesting, fallback, synchronous blocking,
the bounded drain, and local-task owner affinity after that drain.
