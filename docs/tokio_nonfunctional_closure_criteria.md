...
```
# Example CI gate
rch exec -- env CARGO_TARGET_DIR=${TMPDIR:-/tmp}/rch_target_tokio_nonfunctional_closure_docs cargo bench --features criterion-benches --bench <suite> -- --save-baseline current
